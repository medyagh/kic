...
kubectl get pods -A
kubectl wait pod -l component=kube-apiserver --for condition=Initialized --timeout=100s -n kube-system
kubectl wait pod -l component=kube-apiserver --for condition=ContainersReady --timeout=100s -n kube-system
kubectl wait pod -l component=kube-apiserver --for condition=PodScheduled --timeout=100s -n kube-system
